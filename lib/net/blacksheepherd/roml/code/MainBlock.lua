...
local DoBlock = require("net.blacksheepherd.roml.code.DoBlock")
local SpaceBlock = require("net.blacksheepherd.roml.code.SpaceBlock")
local DoubleBlock = require("net.blacksheepherd.roml.code.DoubleBlock")
local TableBlock = require("net.blacksheepherd.roml.code.TableBlock")
local MetatableBlock = require("net.blacksheepherd.roml.code.MetatableBlock")
local IfElseBlock = require("net.blacksheepherd.roml.code.IfElseBlock")
local IfBlock = require("net.blacksheepherd.roml.code.IfBlock")
local Line = require("net.blacksheepherd.roml.code.Line")
local RequireLine = require("net.blacksheepherd.roml.code.RequireLine")
local MainBlock
do
  local _base_0 = {
  ...
  local _class_0 = setmetatable({
    __init = function(self, name)
      self._children = { }
      table.insert(self._children, RequireLine("net.blacksheepherd.roml", "RomlVar"))
      table.insert(self._children, RequireLine("net.blacksheepherd.roml", "RomlDoc"))
      table.insert(self._children, RequireLine("net.blacksheepherd.roml", "RomlObject"))
      table.insert(self._children, RequireLine("net.blacksheepherd.roml", "ObjectBuilder"))
