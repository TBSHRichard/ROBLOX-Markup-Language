...
do
  ...
  local _base_0 = {
    ...
    BeforeRender = function(self)
      return tostring(self._indent) .. tostring(self._name) .. "[\"" .. tostring(self._key) .. "\"] = {"
    end,
  ...
  local _class_0 = setmetatable({
    __init = function(self, name, key)
      _parent_0.__init(self)
      self._name = name
      self._key = key
    end,
    __base = _base_0,
    __name = "TableAssignmentBlock",
    __parent = _parent_0
  }, {
